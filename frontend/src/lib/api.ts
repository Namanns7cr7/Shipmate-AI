...
import type {
  ...
  ScorePoint, ShipMateReport, BuildPlanResponse, BuildExecuteResponse, Opportunity,
} from '../types';
...
// Token is held module-level and injected via interceptor — never in URLs.
...
// Header builder for raw fetch() SSE calls (bypasses axios).
